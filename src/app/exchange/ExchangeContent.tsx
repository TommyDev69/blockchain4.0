...
export default function ExchangeContent({Title, Result}:tradingProps) {
  return (
    <div>
      ...
      <div className="container w-10/12 flex  mx-auto md:mx-0  flex-col  my-16  bg-[#040D26] relative rounded-lg" key={dataItem.id}>
